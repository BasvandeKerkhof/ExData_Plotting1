#This script provides the code to create plot 4 of the first course project of 
...
#Create the 4 plots
#Specify the number of columns and rows to for the plots
par(mfrow = c(2, 2))
...
#Upper right plot
plot(date_time, data$Voltage, xlab = "datetime", 
     ylab = "Voltage", type = "n")
